...
function Roadmap() {
  return (
    <div id="map" className='relative md:mt-[800px] mt-[400px] pt-[30px] md:bg-roadmap bg-cover bg-top bg-no-repeat'>
      <div className='w-full absolute top-0 md:-translate-y-[75%] -translate-y-[25%] z-0'>
        <img src="/img/connection1.png" alt="" className='w-full' />
      </div>
      <h1 className="text-white text-[10vw] md:text-[60px] font-irish my-8 md:my-12 text-center uppercase"> Cloudbunnies roadmap </h1>
      <div className='flex flex-col md:max-w-[80%] mx-auto w-full relative'>
        ...
        <MapItem inverse={false} id="03]" title="Children Charity Donation" desc="Once the mint is complete, we will be donating a certain percentage (e.g. 10%) of our primary mint sales to UNICEF in aiding children all over the world. However, should we sell out, we will be donating 15% of our entire sales. The money donated will be used by UNICEF to provide humanitarian support to countries in dire need of assistance (e.g. Children in Ukraine)" />
        <MapItem inverse={true} id="04]" title="Secret airdrop for holders" desc="Once the mint is complete, we will be creating a holder-only area in our discord where we will offer whitelist spot opportunities for upcoming projects which we believe may have potential, these whitelist spots will be designated for our holders via raffles, games and much more. No far fetched and unreasonable promises." />
